                ...
                <div v-if="!prova">
                    ...
                    <form action="" class="ms-5">
                        ...
                        <div class="input mb-2">
                            ...
                            <input class="form-control" type="text" name="name" id="name" placeholder="Nome" v-model="name" required/>
                        ...
                        <div class="input mb-5">
                            ...
                            <input class="form-control" type="text" name="phone" id="phone" placeholder="Telefono" v-model="phone" />
                        </div>
                    </form>
