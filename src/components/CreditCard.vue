                ...
                <div class="card-item" v-bind:class="{ '-active': isCardFlipped }">
                    <div class="card-item__side -front">
                        ...
                        <div class="card-item__cover">
                            <img v-bind:src="'https://raw.githubusercontent.com/muhammederdem/credit-card-form/master/src/assets/images/' +
                            currentCardBackground + '.jpeg'" class="card-item__bg">
                        </div>
                            ...
                            <div class="card-item__top">
                                ...
                                <div class="card-item__type">
                                    <transition name="slide-fade-up">
                                        <img v-bind:src="'https://raw.githubusercontent.com/muhammederdem/credit-card-form/master/src/assets/images/'
                                        + getCardType + '.png'" v-if="getCardType" v-bind:key="getCardType" alt=""
                    ...
                    <div class="card-item__side -back">
                        ...
                        <div class="card-item__cvv">
                            ...
                            <div class="card-item__type">
                                <img v-bind:src="'https://raw.githubusercontent.com/muhammederdem/credit-card-form/master/src/assets/images/' +
                                getCardType + '.png'" v-if="getCardType" class="card-item__typeImg">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card-form__inner">
                <div class="card-input">
                    ...
                    <input type="text" id="cardNumber" class="card-input__input" v-mask="generateCardNumberMask"
                        v-model="cardNumber" @focus="focusInput(e)" @blur="blurInput" data-ref="cardNumber"
                        autocomplete="off">
                </div>
                <div class="card-input">
                    <label for="cardName" class="card-input__label">Card Holders</label>
                    <input type="text" id="cardName" class="card-input__input" v-model="cardName"
                        @focus="focusInput(e, $refs)" @blur="blurInput" data-ref="cardName" autocomplete="off">
                </div>
                    ...
                    <div class="card-form__col">
                        <div class="card-form__group">
                            ...
                            <select class="card-input__input -select" id="cardMonth" v-model="cardMonth"
                                @focus="focusInput(e, $refs)" @blur="blurInput" data-ref="cardDate">
...
export default {
    ...
    setup() {
        ...
        const cardNumberTemp = ref(otherCardMask.value);
        ...
        const getCardType = computed(() => {
            ...
            //   let re = new RegExp("^4");
            //   let numberString = cardNumber.value.toString();
